...
export default function Projects() {
    ...
    const projects = [
        ...
        },
        {
            ...
            tags: ["React.js", "TypeScript", "Tailwind CSS", "Vite", "Cloudflare"],
            image: "https://placehold.co/600x400/0f172a/FFFFFF/webp?text=Portfolio+Website",
            github: "https://github.com/VIREN2779/viren-patadiya",
            demo: "https://viren-patadiya.pages.dev/",
                        ...
                        {projects.map((project, index) => (
                            ...
                            >
                                <Card className="py-0 overflow-hidden border-0 shadow-lg h-full flex flex-col">
                                    ...
                                    <CardFooter className={`bg-gray-50 p-4 flex items-center ${project.title !== "E-Commerce Website" ? "justify-between" : "justify-end"}`}>
                                        {project.title !== "E-Commerce Website" && (
                                            <Button
                                                variant="outline"
                                                size="sm"
                                                className="flex items-center gap-1.5 hover:bg-blue-600 hover:text-white cursor-pointer"
